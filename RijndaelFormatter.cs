...
namespace Forge.Formatters
{
    ...
    public sealed class RijndaelFormatter<T> : IDataFormatter<T>
    {
        ...
        public RijndaelFormatter(byte[] iv, byte[] key, IDataFormatter<T> internalFormatter) : this(iv, key)
        {
            ...
            mInternalFormatter = internalFormatter;
        }
                ...
                try
                {
                    using (RijndaelManaged r = new RijndaelManaged())
                    {
                        ...
                        using (ICryptoTransform decryptor = r.CreateDecryptor())
                        {
                            ...
                            mInternalFormatter.Read(csDecrypt);
                        }
                    }
                }
                catch (Exception)
        ...
        public bool CanWrite(T item)
        {
            ...
            try
            {
                ...
                {
                    mInternalFormatter.Write(ms, item);
                    ms.Position = 0;
        ...
        public T Read(Stream stream)
        {
            ...
            try
            {
                using (RijndaelManaged r = new RijndaelManaged())
                {
                    ...
                    {
                        CryptoStream csDecrypt = new CryptoStream(stream, decryptor, CryptoStreamMode.Read);
                        return mInternalFormatter.Read(csDecrypt);
                    }
                }
            }
        ...
        public void Write(Stream outputStream, T data)
        {
            ...
            try
            {
                using (MemoryStream ms = new MemoryStream())
                {
                    mInternalFormatter.Write(ms, data);
                    ms.Position = 0;
        ...
        public object Clone()
        {
            ...
            cloned.mInternalFormatter = mInternalFormatter;
            cloned.mIV = mIV;
            cloned.mKey = mKey;
            return cloned;
        }
